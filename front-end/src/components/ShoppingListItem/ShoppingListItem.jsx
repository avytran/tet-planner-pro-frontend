...
export default function ShoppingListItem({
  ...
  return (
    <div
      className={`px-6 py-5 justify-items-start rounded-2xl flex justify-between items-center gap-3 w-xs md:w-sm  ${bgColor} relative`}
    >
      ...
      <div className={`flex-7 ${textColor}`}>
        ...
        <p className="text-base font-normal text-left">{price} VND</p>
      </div>
