...
export const ShoppingFilter = ({
  ...
  const getPercent = (value) =>
    MAX_PRICE_LIMIT > 0 ? Math.round((value / MAX_PRICE_LIMIT) * 100) : 0;
  ...
  return (
    <div className="w-full md:w-[220px] shrink-0 text-left rounded-xl p-4 shadow-md border border-gray-200 bg-surface">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-bold text-2xl text-primary-strong font-sans">
          Filter
        </h3>
      </div>
      ...
      {/* STATUS */}
      <div className="mb-4">
        <h4 className="font-semibold text-primary-strong text-base mb-2 font-sans text-left">
          Status
        </h4>
      ...
      <div className="mb-4">
        ...
        <div className="flex flex-col gap-1 max-h-[140px] overflow-y-auto">
          {categories.length > 0 ? (
            ...
            <span className="text-xs text-primary-strong/65 italic font-sans">
      ...
      <div>
        <div className="flex items-baseline gap-1 mb-3">
          <h4 className="font-semibold text-primary-strong text-base font-sans text-left">
            Price Range
          </h4>
        </div>
        ...
        <div className="flex flex-col gap-1 mt-3 w-full">
          ...
          <div className="flex items-center gap-1 text-[9px] text-primary-strong/65">
            <span className="w-[75px] text-center">
              {formatPrice(filters.priceRange[0])} VND
            </span>
            <span className="shrink-0">-</span>
            <span className="w-[75px] text-center">
              {formatPrice(filters.priceRange[1])} VND
            </span>
          </div>
        </div>
      </div>
